...
export const extraActivityCatalog: Record<ExtraActivityType, ActivityConfig> = {
  ...
  indoor_cycle: { label: "Sisäpyöräily", met: 8.8 },
  treadmill: { label: "Juoksumatto", met: 8.6 },
  stair_climber: { label: "Porraslaite", met: 8.8 },
  elliptical: { label: "Crosstrainer", met: 5.8 },
  mtb: { label: "Maastopyöräily", met: 8.5 },
  downhill_ski: { label: "Laskettelu", met: 6.8 },
  disc_golf: { label: "Frisbeegolf", met: 4.0 },
  skate: { label: "Luistelu", met: 7.0 },
  paddle: { label: "Melonta", met: 6.0 },
