  ...
  assignedMealPlans: [
    {
      ...
      items: [
        ...
        { id: "assigned_meal_plan_item_2", mealTag: "lunch", recipeId: "recipe_chicken_rice", sortOrder: 1 },
        { id: "assigned_meal_plan_item_3", mealTag: "dinner", recipeId: "recipe_chicken_rice", sortOrder: 2 },
        { id: "assigned_meal_plan_item_4", mealTag: "evening_snack", recipeId: "recipe_skyr_oats", sortOrder: 3 },
      ],
      active: true,
      assignedAt: iso(-3),
      updatedAt: iso(-2),
