...
export const recipeSeedData = [
  ...
  recipe({
    ...
    ingredients: [
      ...
      ingredient("Kreikkalainen jogurtti 2%", 80, "g", { groupLabel: "Kermainen kerros" }),
  ...
  // ===== YHTEISÖRESEPTIT (lisätty seedistä käsin, ei Laalon ruokaohjelma -PDF:stä) =====
  recipe({
    name: "Snickers-tuorepuuro",
    description:
      "Snickers-henkinen proteiinituorepuuro maapähkinävoilla, banaanilla, paahdetuilla maapähkinöillä ja tummasuklaavalulla. Karkea maapähkinävoi tuo lisää rakennetta ilman että makrot muuttuvat merkittävästi.",
    mealTag: "breakfast",
    ...singleServe,
    ingredients: [
      ingredient("Kaurahiutale", 35, "g", { groupLabel: "Pohja" }),
      ingredient("Kreikkalainen jogurtti 0%", 125, "g", { groupLabel: "Pohja" }),
      ingredient("Mantelimaito", 40, "ml", { groupLabel: "Pohja", alternatives: ["Rasvaton maito"] }),
      ingredient("Vaniljaproteiinijauhe", 15, "g", { groupLabel: "Pohja" }),
      ingredient("Chian siemenet", 8, "g", { groupLabel: "Pohja" }),
      ingredient("Kaakaojauhe", 8, "g", { groupLabel: "Pohja" }),
      textIngredient("Makeutusaine tai hunaja", "maun mukaan", "", { groupLabel: "Pohja" }),
      ingredient("Maapähkinävoi 99%", 8, "g", { groupLabel: "Täytteet" }),
      ingredient("Banaani", 0.5, "pcs", { groupLabel: "Täytteet", displayQuantity: "½", displayUnit: "kpl" }),
      ingredient("Paahdetut maapähkinät", 5, "g", { groupLabel: "Täytteet" }),
      ingredient("Tumma suklaa", 5, "g", { groupLabel: "Päälle" }),
  ...
  recipe({
    name: "Valkosipulivoikana ja kermaiset perunat",
    description:
      "Maukas meal prep -ateria: meheviä valkosipulivoikanakuutioita ja rapeita uuniperunoita kermaisessa valkosipuli-yrttikastikkeessa. Helppo valmistaa ja loistavat makrot. Valmistuu neljäksi annokseksi.",
    mealTag: "lunch",
    ...batchServe,
    ingredients: [
      ingredient("Kanan rintafilee", 800, "g", { groupLabel: "Valkosipulivoikana" }),
      textIngredient("Suola", "1½", "tl", { groupLabel: "Valkosipulivoikana" }),
      textIngredient("Kuivattu persilja", "2", "tl", { groupLabel: "Valkosipulivoikana" }),
      textIngredient("Chilihiutaleet", "1", "tl", { groupLabel: "Valkosipulivoikana" }),
      textIngredient("Valkosipulijauhe", "2", "tl", { groupLabel: "Valkosipulivoikana" }),
      textIngredient("Sipulijauhe", "2", "tl", { groupLabel: "Valkosipulivoikana" }),
      textIngredient("Paprikajauhe", "2", "tl", { groupLabel: "Valkosipulivoikana" }),
      ingredient("Oliiviöljy", 10, "g", { groupLabel: "Valkosipulivoikana", displayQuantity: "2", displayUnit: "tl" }),
      ingredient("Kevytvoi 60 %", 25, "g", { groupLabel: "Valkosipulivoikana" }),
      ingredient("Valkosipuli", 15, "g", { groupLabel: "Valkosipulivoikana", displayQuantity: "1", displayUnit: "rkl" }),
      textIngredient("Tuore persilja", "1", "rkl", { groupLabel: "Valkosipulivoikana" }),
      ingredient("Peruna", 800, "g", { groupLabel: "Kermaiset yrttiperunat" }),
      textIngredient("Suola", "1", "tl", { groupLabel: "Kermaiset yrttiperunat" }),
      textIngredient("Kuivattu persilja", "1", "tl", { groupLabel: "Kermaiset yrttiperunat" }),
      textIngredient("Chilihiutaleet", "1", "tl", { groupLabel: "Kermaiset yrttiperunat" }),
      textIngredient("Valkosipulijauhe", "1", "tl", { groupLabel: "Kermaiset yrttiperunat" }),
      textIngredient("Sipulijauhe", "1", "tl", { groupLabel: "Kermaiset yrttiperunat" }),
      textIngredient("Paprikajauhe", "1", "tl", { groupLabel: "Kermaiset yrttiperunat" }),
      textIngredient("Oliiviöljy tai öljysuihke (valinnainen)", "valinnainen", "", { groupLabel: "Kermaiset yrttiperunat" }),
      ingredient("Rasvaton maito", 250, "ml", { groupLabel: "Kermaiset yrttiperunat" }),
      ingredient("Valkosipuli-yrttituorejuusto", 150, "g", { groupLabel: "Kermaiset yrttiperunat", alternatives: ["Tuorejuusto 11%"] }),
    ],
    instructions: [
      "Kuutioi kananrinta suupaloiksi. Sekoita joukkoon suola, kuivattu persilja, chilihiutaleet, valkosipulijauhe, sipulijauhe, paprikajauhe ja oliiviöljy. Sekoita, kunnes kana on tasaisesti maustunut, ja anna marinoitua hetki.",
      "Kuutioi pestyt perunat pieniksi kuutioiksi ja mausta samoilla mausteilla kuin kana. Lisää halutessasi tilkka öljyä tai öljysuihketta. Levitä perunat leivinpaperille pellille ja paista 200 °C:ssa (uunissa tai airfryerissä) noin 20–22 minuuttia, kunnes ne ovat kullanruskeita ja rapeita.",
      "Kuumenna pannu keskilämmöllä ja sulata kevytvoi. Paista kanakuutioita 6–8 minuuttia, laske sitten lämpöä. Lisää loput voista, valkosipulisilppu ja tuore persilja. Sekoita, kunnes kana on kauttaaltaan maustevoin peitossa, ja siirrä sivuun.",
      "Lisää samaan pannuun miedolla lämmöllä rasvaton maito ja valkosipuli-yrttituorejuusto. Sekoita jatkuvasti, kunnes kastike on sulanut sileäksi ja hieman paksuuntunut.",
      "Käännä rapeat perunat varovasti kermaiseen kastikkeeseen, kunnes ne ovat kauttaaltaan sen peitossa. Tarjoile valkosipulivoikanan kanssa ja nauti!",
    ],
  }),
  recipe({
    name: "Välimeren kanabowl",
    description:
      "Raikas ja proteiinipitoinen välimerellinen kanabowl: uunikanaa, basmatiriisiä, tuoretta fetasalaattia ja sitruunainen jogurttikastike. Yllättävän helppo arkiruoka yhdelle.",
    mealTag: "lunch",
    ...singleServe,
    ingredients: [
      ingredient("Kanan rintafilee", 150, "g", { groupLabel: "Kana ja riisi" }),
      ingredient("Basmatiriisi", 75, "g", { groupLabel: "Kana ja riisi" }),
      ingredient("Oliiviöljy", 5, "g", { groupLabel: "Kana ja riisi", displayQuantity: "1", displayUnit: "tl" }),
      textIngredient("Suola", "ripaus", "", { groupLabel: "Kana ja riisi" }),
      textIngredient("Mustapippuri", "ripaus", "", { groupLabel: "Kana ja riisi" }),
      textIngredient("Italialainen mausteseos", "maun mukaan", "", { groupLabel: "Kana ja riisi" }),
      textIngredient("Paprikamauste", "maun mukaan", "", { groupLabel: "Kana ja riisi" }),
      ingredient("Kreikkalainen jogurtti 2%", 50, "g", { groupLabel: "Jogurttikastike" }),
      textIngredient("Valkosipuli (hienonnettuna)", "½", "kynttä", { groupLabel: "Jogurttikastike" }),
      ingredient("Sitruunamehu", 5, "ml", { groupLabel: "Jogurttikastike", displayQuantity: "loraus", displayUnit: "" }),
      textIngredient("Suola ja mustapippuri", "ripaus", "", { groupLabel: "Jogurttikastike" }),
      ingredient("Kurkku", 75, "g", { groupLabel: "Salaatti", displayQuantity: "¼", displayUnit: "" }),
      ingredient("Kirsikkatomaatti", 100, "g", { groupLabel: "Salaatti", displayQuantity: "n. 7", displayUnit: "kpl" }),
      ingredient("Punasipuli", 25, "g", { groupLabel: "Salaatti", displayQuantity: "¼", displayUnit: "" }),
      ingredient("Fetajuusto", 20, "g", { groupLabel: "Salaatti" }),
      textIngredient("Tuoretta persiljaa", "maun mukaan", "", { groupLabel: "Salaatti" }),
      textIngredient("Balsamico ja oliiviöljy (valinnainen)", "valinnainen", "", { groupLabel: "Salaatti" }),
    ],
    instructions: [
      "Keitä basmatiriisi pakkauksen ohjeen mukaan kypsäksi.",
      "Mausta kananrinta oliiviöljyllä, suolalla, pippurilla, italialaisella mausteseoksella ja paprikamausteella. Anna marinoitua hetki.",
      "Paista kana 200 °C:ssa uunissa noin 20–30 minuuttia, kunnes se on kypsää. Leikkaa viipaleiksi.",
      "Sekoita kastike: kreikkalainen jogurtti, ripaus suolaa ja pippuria, hienonnettu valkosipuli ja tilkka sitruunamehua.",
      "Pilko kurkku, punasipuli, kirsikkatomaatit ja persilja sekä murenna feta. Sekoita salaatiksi ja mausta halutessasi balsamicolla, oliiviöljyllä ja italialaisella mausteseoksella.",
      "Kokoa annos: riisi, paistettu kana ja salaatti. Lusikoi päälle jogurttikastike ja viimeistele sitruunamehulla ja tuoreella persiljalla.",
    ],
  }),
];
