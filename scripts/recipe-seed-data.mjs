...
export const recipeSeedData = [
  ...
  recipe({
    ...
    ingredients: [
      ...
      ingredient("Kevyt maito", 250, "ml", { groupLabel: "Kermaiset yrttiperunat" }),
    ...
    instructions: [
      ...
      "Lisää samaan pannuun miedolla lämmöllä kevytmaito ja valkosipuli-yrttituorejuusto. Sekoita jatkuvasti, kunnes kastike on sulanut sileäksi ja hieman paksuuntunut.",
