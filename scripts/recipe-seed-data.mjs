...
export const recipeSeedData = [
  ...
  recipe({
    ...
    ...batchServe,
    ingredients: [
      ingredient("Kanan rintafilee", 600, "g", { groupLabel: "Kana" }),
      gentleIngredient("Paprikamauste", 2, "g", { groupLabel: "Kana", ingredientRole: "spice" }),
      textIngredient("Timjami", "½", "tl", { groupLabel: "Kana" }),
      gentleIngredient("Valkosipulijauhe", 4, "g", { groupLabel: "Kana", ingredientRole: "spice" }),
      gentleIngredient("Sipulijauhe", 4, "g", { groupLabel: "Kana", ingredientRole: "spice" }),
      gentleIngredient("Oregano", 4, "g", { groupLabel: "Kana", ingredientRole: "spice" }),
      gentleIngredient("Suola", 5, "g", { groupLabel: "Kana", ingredientRole: "spice" }),
      ingredient("Margariini alle 50% rasvaa", 20, "g", { groupLabel: "Alfredo-kastike", displayQuantity: "1", displayUnit: "rkl" }),
      ingredient("Sipuli", 60, "g", { groupLabel: "Alfredo-kastike", displayQuantity: "1", displayUnit: "kpl (salottisipuli)" }),
      ingredient("Valkosipuli", 9, "g", { groupLabel: "Alfredo-kastike", displayQuantity: "3", displayUnit: "kynttä" }),
      textIngredient("Timjami", "¼", "tl", { groupLabel: "Alfredo-kastike" }),
      gentleIngredient("Oregano", 4, "g", { groupLabel: "Alfredo-kastike", ingredientRole: "spice" }),
      gentleIngredient("Suola", 3, "g", { groupLabel: "Alfredo-kastike", ingredientRole: "spice" }),
      ...
      gentleIngredient("Paprikamauste", 4, "g", { groupLabel: "Perunat", ingredientRole: "spice" }),
      gentleIngredient("Oregano", 4, "g", { groupLabel: "Perunat", ingredientRole: "spice" }),
      textIngredient("Timjami", "1", "tl", { groupLabel: "Perunat" }),
      gentleIngredient("Suola", 5, "g", { groupLabel: "Perunat", ingredientRole: "spice" }),
      gentleIngredient("Mustapippuri", 2, "g", { groupLabel: "Perunat", ingredientRole: "spice" }),
      textIngredient("Parsakaali", "valinnainen", "", { groupLabel: "Lisäksi" }),
    ],
    instructions: [
      "Paahda perunat: kuumenna uuni 220 asteeseen (kiertoilma). Levitä lohkotut perunat yhteen kerrokseen uunipellille, suihkauta päälle oliiviöljyä ja mausta paprikamausteella, oreganolla, timjamilla, suolalla ja pippurilla. Sekoita hyvin ja paahda 35–40 minuuttia, käännellen puolivälissä, kunnes perunat ovat kullanruskeita ja rapeita.",
      "Kypsennä kana: mausta kuutioitu kana. Kuumenna tarttumaton pannu keski-korkealla lämmöllä, suihkauta kevyesti öljyä ja paista kanaa 5–6 minuuttia, kunnes se on kullanruskeaa ja kypsää. Nosta sivuun.",
      "Valmista Alfredo-kastike: laske lämpö keskilämmölle ja sulata margariini samalla pannulla. Lisää salottisipuli ja kuullota 2–3 minuuttia. Lisää valkosipuli, yrtit, suola ja pippuri, ja kypsennä 30 sekuntia tuoksuvaksi. Kaada joukkoon valkoviini ja anna kiehua 30–60 sekuntia, kunnes se on lähes haihtunut. Sekoita joukkoon vehnäjauho ja kypsennä minuutti, vispaa sitten maito vähitellen joukkoon tasaiseksi. Anna kiehua 2–3 minuuttia, kunnes kastike sakenee. Sekoita joukkoon kerma ja parmesaani, kunnes kastike on silkkistä.",
